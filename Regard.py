...
parser.add_argument('--batch-size', type=int, default=110, metavar='N',
                    help='input batch size for training (default: 64)')
parser.add_argument('--test-batch-size', type=int, default=25, metavar='N',
...
train_loader = torch.utils.data.DataLoader(torchvision.datasets.ImageFolder('datasetN/Train',
transforms.Compose([transforms.CenterCrop(150),
transforms.ToTensor()])), batch_size=args.batch_size,shuffle=True)

test_loader = torch.utils.data.DataLoader(torchvision.datasets.ImageFolder('datasetN/Test',
transforms.Compose([transforms.CenterCrop(150),
transforms.ToTensor()])), batch_size=args.test_batch_size,shuffle=True)
